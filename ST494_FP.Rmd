...
## 2.1 PCA: Generating Principle Components
...
## 2.2 Impact of Variables on the First Principle Component
...
## 2.3 Proportion of Variance Explained (PVE)
...
## 2.4 Projecting Data Onto the First 2 Principal Components
...
## 2.6 K-Means Clustering on PC1 and PC2
...
```{r}
y_nn_binary <- ifelse(selected_train$gpa_desirable=="Desirable", 1, 0)
test_binary <- selected_test |> 
  select(-c(gpa, gpa_letter)) |> 
  transform(gpa_desirable = ifelse(gpa_desirable=="Desirable", 1, 0))
